...
export const ProfileEditWidget = (props, history) => {
  ...
  const filterSteps = (step) => {
    ...
    return step.pattern.match(/\/start|\/business-details|\/business-info|\/your-info|\/disclosures|\/documents|\/tools|\/awards|\/recruiter|\/domains|\/resumes|\/case-study|\/candidates|\/products|\/update/);
  };
  return (
