...
test('submitApplication action', () => {
    ...
    const expectedActions = [
        ...
        { type: actionTypes.CHANGE, model: 'firstForm', multi: false, external: true,
          silent: false, value: { foo: 'bar', baz: 'foo'}},
        { type: actionTypes.CHANGE, model: 'secondForm', multi: false, external: true,
          silent: false, value: { bar: 'baz', foobar: 'barfoo'}},
        { type: types.APP_POST_SUBMIT },
    ]
