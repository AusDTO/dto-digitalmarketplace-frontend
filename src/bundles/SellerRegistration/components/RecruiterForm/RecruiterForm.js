                        ...
                        <div styleName="content">
                            ...
                            {this.props[model].recruiter && (
                                <fieldset>
                                    ...
                                    />
                                    <p>Some states operate under a mandated Labour Hire Licensing Act. You will require a relevant license if you plan to supply candidates in VIC, SA or QLD.</p>
                                    {states.map(s => (
