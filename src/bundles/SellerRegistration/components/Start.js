            ...
            {!isNumber(supplierCode) ? (
                <div>
                    ...
                    <p>By completing this application you are automatically responding to an open approach to market, whose terms and
                        conditions, like other government tenders, are <a href="http://tenders.gov.au" target="_blank" rel="external noopener noreferrer">publicly available.</a></p>
                    ...
                    <p>
                        <a href="/api/2/r/master-agreement-current.pdf" target="_blank" rel="noopener noreferrer">Download Digital Marketplace Master Agreement (PDF 245KB)</a><br/><br/>
                    </p>
                    <p>
                    ...
                    <div>
                        ...
                        <p>We recommend adding case studies for services you are already approved to offer. For additional
                            services you will need to provide case studies and referees to confirm you meet our <a
                                href="/assessment-criteria" target="_blank" rel="nopener noreferrer">assessment criteria</a>.</p>
                        <h2 className="au-display-lg">You will need</h2>
                        <ul>
                            <li> Recent financial records or a viability statement from your accountant</li>
                            <li> Proof of current insurance cover</li>
                        </ul>
                        <a href="/api/2/r/master-agreement-current.pdf" target="_blank" rel="noopener noreferrer">Download Digital Marketplace Master Agreement PDF</a><br/><br/>
                        <SaveError/>
                        <p>
                            <a className="button" href={signup} onClick={onClick}>Start Now </a>
                        </p>
