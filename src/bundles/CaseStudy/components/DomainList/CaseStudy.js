...
class CaseStudy extends Component {
  getStudiesByService(studies, service) {
    return Object
      .keys(studies)
  ...
  render() {
    let {match, domain, index, caseStudyForm, onEditCaseStudy, onDeleteCaseStudy, onAddCaseStudy, actions} = this.props;
    let list = this.getStudiesByService(caseStudyForm.case_studies, domain);
