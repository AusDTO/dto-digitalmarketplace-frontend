export const templateString  = (
  ...
  "Thank you for submitting a seller application to the Digital Marketplace."+"\n"+"\n"+

    "We have just reviewed your application and it is looking good but there are a few small items to be attended to."+"\n"+"\n"+
