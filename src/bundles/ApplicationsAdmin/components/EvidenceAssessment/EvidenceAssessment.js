      ...
      return (
        <div>
          ...
          {this.hasMetEnoughCriteria() && this.hasReviewedAllCriteria() && (
            <React.Fragment>
              <p>
                <strong>Considering the maximum day rate provided by the seller, and based on your assessment of the seller&apos;s technical capabilities, does this seller&apos;s application represent VFM to the Commonwealth?</strong>
              </p>
