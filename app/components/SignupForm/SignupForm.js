      ...
      case 409:
        return {
          ...
          signupMessage: (
            <li>
              <p>
                An account with this email domain already exists. Someone in
                your team may have already created an account with the
                Marketplace.
              </p>
            </li>
          )
      ...
      default:
        return {
          ...
          signupMessage: (
            <li>
              <p>
                The Digital Marketplace encountered an error trying to send your
                signup email. Please try again later or{' '}
              ...
              <div>
                ...
                <article role="main">
                  ...
                  {isBuyer && signupForm.employment_status === 'contractor'
                    ? <div>
                        <p>
                          An email has been sent to your manager at{' '}
                          <strong>{signupForm.line_manager_email}</strong> with
                          next steps.
                        </p>
                        <p>
                          If they don’t receive the email within the next 5
                          minutes or so, check to see if it’s been classified as
                          spam or
                          <a href="/contact-us" target="_blank" rel="external">
                            {' '}contact us{' '}
                          </a>{' '}
                    ...
                    : <div>
                        <p>
                          ...
                          <strong>{signupForm.email_address}</strong> with next
                          steps.
                        </p>
                        <p>
                          If you don’t receive the email within the next 5
                          minutes or so, check to see if it’s been classified as
                          spam or
                          <a href="/contact-us" target="_blank" rel="external">
                            {' '}contact us{' '}
                  ...
                  >
                    ...
                    <Textfield
                      ...
                      description={
                        isBuyer
                          ? <span>
                              If your email is different, request your account
                              from{' '}
                              <a href="mailto:marketplace@digital.gov.au">
                    ...
                    {employmentStatus &&
                      ...
                      <div>
                        <p>
                          To create your account we will also need approval from
                          a line manager who:
                        </p>
                        <ul>
                          <li>
                            Is an employee under the Commonwealth Public Service
                            Act (1999) or under equivalent State or Territory
                            legislation, and
                          </li>
                          <li>
                            is satisfied you need to access the Digital
                            Marketplace.
                          </li>
                        </ul>
                        <Textfield
                          ...
                          messages={{
                            required:
                              'You must provide the name of your manager'
                          }}
                        />
                        <Textfield
                        ...
                        />
                        <p>
                          Remember to let this person know we’ll be sending them
                          an email requesting their authorisation.
                        </p>
                      </div>}
                    {children}
                    <p>
                      <small>
                        By creating an account you confirm your acceptance of
                        our{' '}
