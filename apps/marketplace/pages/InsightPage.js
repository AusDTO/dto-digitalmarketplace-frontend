        ...
        <div className="au-grid">
          ...
          <div className={`row ${styles.marginBottom5}`}>
            <div className="col-xs-12">
              ...
              <b>It breaks down the barriers of entry for SMEs (self-reported)</b> (a small to medium enterprise with
              less than 200 employees) and makes it{' '}
              <b>easier to compete for the Australian Government’s annual ICT spend</b>.
            </div>
          </div>
