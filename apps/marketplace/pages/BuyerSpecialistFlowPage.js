...
import BuyerSpecialistStages from 'marketplace/components/BuyerSpecialist/BuyerSpecialistStages'
...
const model = 'BuyerSpecialistForm'

export class BuyerSpecialistFlowPage extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    return (
      <ProgressFlow
        model={model}
        basename={`${rootPath}/buyer-specialist/${briefId}`}
        stages={BuyerSpecialistStages}
...
export default connect(mapStateToProps, mapDispatchToProps)(BuyerSpecialistFlowPage)
