      ...
      <div className="row">
        <div className="col-md-offset-1 col-md-8 col-md-push-3">
          ...
          <div className="au-footer__end">
            <div className="footer__content footer__legal">
              <p>
                An initiative of the <a href="https://www.dta.gov.au/">Digital Transformation Agency</a>.{' '}
                This program forms part of the National Innovation and Science <a href="https://innovation.gov.au/page/agenda">Agenda</a>.{' '}
        ...
        <div className="col-md-3 col-md-pull-9 footer__logo">
          <div className="au-footer-logo-dta">
            <a href="https://www.dta.gov.au/"><div dangerouslySetInnerHTML={{ __html: logoDTA }} /></a>
          </div>
          <div className="au-footer-logo-nisa">
            <a href="https://innovation.gov.au/page/agenda"><div dangerouslySetInnerHTML={{ __html: logoNISA }} /></a>
          </div>
        </div>
      </div>
    </div>
