            ...
            <Form model={model} id="briefResponse" onSubmit={data => handleSubmit(data)}>
              ...
              {showTrainerResumes && (
                <FilesInput
                  ...
                  description="Please submit the résumés of the trainers you have in mind to deliver this training. The Marketplace recommends up to 3 résumés (which you’ll need to merge into one document)."
                  name="attachedDocumentURL"
