...
import { required, validEmail, validPercentage } from '../../components/validators'
import ErrorBox from '../../components/shared/form/ErrorBox'
import Textfield from '../../components/shared/form/Textfield'
import FilesInput from '../../components/shared/form/FilesInput'
import Textarea from '../shared/form/Textarea'
import LoadingButton from '../../components/LoadingButton/LoadingButton'

const BriefResponseForm = props => {
  const {
    model,
    brief,
  ...
  return (
    <div className="row">
      <div className="col-sm-push-2 col-sm-8 col-xs-12">
        <article role="main">
          {briefResponseSuccess && <Redirect to={`${props.match.url}/respond/submitted`} />}
          {!briefResponseSuccess &&
            <ErrorBox
