...
const BuyerTrainingCompleted = props => {
  ...
  return (
    <div>
      <AUpageAlert as="success">
        ...
        <p>
          It will be open until {format(props.closingDate, 'dddd D MMMM YYYY')} at {closingTime} Canberra time.
        </p>
      </AUpageAlert>
      ...
      <p className={styles.buttons}>
        <a href={`${rootPath}/brief/${props.briefId}/overview/training2`} className="au-btn au-btn--secondary">
          Return to overview
        </a>
