              ...
              <main>
                <div className="row">
                  <div className="col-xs-12 col-sm-9">
                    <div className="uikit-display-5">{supplierData.name}</div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-xs-12 col-sm-8 col-sm-push-1">
                        <a className={styles.website} href={supplierData.website} target="_blank" rel="external">{supplierData.website}</a>
                      </div>
                    </div>
                  </div>
                  <div className="col-xs-12 col-sm-3">
                    <div className={styles.contactSection}>
                      ...
                      <a href={"mailto:" + supplierData.contact_email} ><div className={styles.yellowButton}>Email Seller</div></a>
                    </div>
                  </div>
                </div>
              </main>
                      ...
                      <div className="row">
                        ...
                        <div className="col-sm-8 col-sm-push-1 col-xs-12">
                          {supplierData.regions.map((region, id = uniqueID()) =>
                            <div key={id}>
                              <div>{region.state + ' ' + region.name}</div>
                            </div>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="row">
                        ...
                        <div className="col-sm-8 col-sm-push-1 col-xs-12">
                          <div className={styles.infoBlock}>
                            ...
                            <div><strong><a href={"mailto:" + supplierData.email} >{supplierData.email}</a></strong></div>
                          </div>
                          <div className={styles.infoBlock}>
                            <div><strong>Headquarter address</strong></div>
                            <div>{supplierData.address_address_line}</div>
                            <div>{supplierData.address_suburb + ' ' + supplierData.address_state + ' ' + supplierData.address_postal_code}</div>
                          </div>
                          <div className={styles.infoBlock}>
                            <div><strong>ABN</strong></div>
                            <a href={`https://abr.business.gov.au/SearchByAbn.aspx?SearchText=${supplierData.abn}`} target="_blank" rel="external"><strong>{supplierData.abn}</strong></a>
                          </div>
                        </div>
                      </div>
                  </div>
