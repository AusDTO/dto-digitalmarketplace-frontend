              ...
              <main>
                <div className="row">
                  <div className="col-xs-12 col-sm-9">
                    <div className="uikit-display-5">{profileData.name}</div>
                    ...
                    <div className={`row ${styles.businessContact}`}>
                      ...
                      <div className="col-xs-12 col-sm-8 col-sm-push-1">
                        <div>{profileData.contact_name}</div>
                        <div>{profileData.contact_phone}</div>
                        <div>
                  ...
                  <div className="col-sm-8 col-xs-12">
                    <div className="row">
                      ...
                      <div className="col-sm-8 col-sm-push-1 col-xs-12">
                        <div className={styles.badge}>{profileData.category_name}</div>
                        <div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-sm-8 col-sm-push-1 col-xs-12">
                        <div className={styles.infoBlock}>
                          ...
                          <div>{profileData.representative}</div>
                        ...
                        <div className={styles.infoBlock}>
                          ...
                          <div>{profileData.address_address_line}</div>
                          <div>
