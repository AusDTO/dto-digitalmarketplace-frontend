    ...
    <main>
      ...
      <nav className="index-links">
        ...
        <ul>
            ...
            <li><a href="#licence">Licence and usage</a></li>
            <li><a href="#disclaimer">Disclaimer</a></li>
            <li><a href="#indemnity">Indemnity</a></li>
            <li><a href="#external-links">External Links</a></li>
            <li><a href="#linking">Linking and syndication</a></li>
      ...
      <section className="tou-section" id="introduction">
        ...
        <p>If you have any questions or feedback about these Terms of Use, please email us at <a
                href="mailto: orams@ato.gov.au"> orams@ato.gov.au</a>.</p>
        <p>The meaning of words can be found in the <a href="#definitions">definitions section.</a></p>
      </section>
      <section className="tou-section" id="security">
        ...
        <ul>
            ...
            <li>There is a risk that your transactions may be seen, intercepted or modified by third parties.
            </li>
            <li>Downloadable files may contain computer viruses, spyware, malware, disabling codes, worms or other devices
                or defects.
            </li>
        </ul>
        <p>We accept no liability for any interference with, or damage to, your computer system, software or data or any
            ...
            recommend reading <a
                    ...
                    rel="external" target="_blank">Protecting Yourself Online (PDF 2.7MB).</a>
        </p>
      ...
      <section className="tou-section" id="registration">
        ...
        <h3>Sellers</h3>
        <p>All sellers must be part of Occupational rehabilitation and associated medical services panel. In order to join this panel, please contact panel management at<a
                href="mailto: orams@ato.gov.au"> orams@ato.gov.au</a>.</p>
      </section>
      ...
      <section className="tou-section" id="code-of-conduct">
        ...
        <p>The Digital Marketplace is designed to make it easier to comply with the Commonwealth Procurement Rules but
            ...
            or procurement team in your entity, where appropriate.</p>

        <p>As a buyer, after signing in, you will have access to a variety of confidential information relating to sellers and opportunity briefs." to "As a buyer, after signing in, you will have access to a variety of confidential information relating to sellers.</p>
      ...
      <section className="tou-section" id="indeminity">
        ...
        against all loss (including reasonable legal costs and expenses) or liability incurred by those indemnified arising
        from any claim, demand, suit, action or proceeding by any person against any of those indemnified where that loss or
        liability arose out of, in relation to:</p>
        <ol>
            <li>Any breach of these Terms of Use by you.</li>
            <li>Publication of or distribution of the material or information supplied by you.
            </li>
        </ol>
      </section>
      <section className="tou-section" id="external-links">
        ...
        <p>You must make your own enquiries and decisions about the accuracy and reliability of any information, and the
            suitability of products or services, on the linked website.</p>
      </section>
      ...
      <section className="tou-section" id="jurisdiction">
        <h2>Jurisdiction</h2>
        <a href="#" className="scroll-to-top">Back to top of page <b>&uarr;</b></a>
        <p>These Terms of Use are governed by the laws of the Australian Capital Territory (ACT), Australia. Any dispute
            must be heard in the courts of the ACT. </p>
        <p>If the ACT court finds any of these Terms of Use invalid, unenforceable or illegal for any reason, the remaining
            Terms of Use will continue to apply in full.</p>
      </section>
      <section className="tou-section" id="definitions">
        ...
        <p>It does not include information that is, or becomes, public knowledge other than by breach of this agreement or a
            work order or any other confidentiality obligation.</p>

        <p>Commonwealth means the Commonwealth of Australia.</p>
        <p>consequential loss means any loss recoverable at law (other than arising in the usual course of things)
            including:</p>
        <ol>
        ...
        <p>entity means a person, partnership, organisation, or business that has a legal and separately identifiable
            existence.</p>
        <p>government employee includes a person engaged under the <em>Public Service Act 1999</em> (or equivalent state or
            territory legislation).</p>
        <p>loss means loss, damage, cost or expense (to any person or property) including consequential loss or indirect
            loss or any loss of profits, data or revenue.</p>
