...
test('removeRow', () => {
  ...
  expect(component.state().inputs).toEqual([{ id: 0, value: 'One' }, { id: 1, value: 'Two' }, { id: 3, value: 'Four' }])
})
...
test('addRow in correct order', () => {
  ...
  expect(preventDefault).toHaveBeenCalled()
  expect(component.state().inputs).toEqual([{ id: 0, value: 'One' }, { id: 1, value: 'Two' }, { id: 2, value: '' }])
})
...
test('addRow in odd order', () => {
  ...
  expect(preventDefault).toHaveBeenCalled()
  expect(component.state().inputs).toEqual([{ id: 0, value: 'Two' }, { id: 1, value: 'One' }, { id: 2, value: '' }])
})
